...
class MetzelertyresspiderSpider(scrapy.Spider):
    ...
    def parse(self, response, **kwargs):
        ...
        for elem in elems:
            ...
            ####################
            try:
                manufacturer_unique_id = driver.find_element_by_xpath(
                    '//*[@id="scheda-rivenditore"]/input[1]'
                ).get_attribute("value")
            ...
            ####################
            try:
                full_address = driver.find_element_by_xpath(
                    '//*[@id="scheda-rivenditore"]/input[3]'
                ).get_attribute("value")
            except Exception as e:
                full_address = ""
            ...
            driver.find_element_by_xpath(
                '//*[@id="scheda-rivenditore-outer"]/div[1]/a'
            ).click()
