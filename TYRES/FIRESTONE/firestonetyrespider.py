    ...
    def parse(self, response, **kwargs):
        ...
        for option_state in options:
            ...
            for option_city in options:
                ...
                ########################################
                dealerloc = driver.find_element_by_xpath(
                    '//*[@id="dealerloc"]'
                        ...
                        if tr != '<tr><td colspan="4">No Dealer Found! </td></tr>':
                            try:
                                ...
                                if "Found" not in store_name_check:
                                    full_address_check = dealerloc_soup.find(
                                        "td"
                                    ...
                                    if full_address_check not in keys:
                                        ...
                                        try:
                                            ...
                                            manufacturer_unique_id = ""
                                            print(
                                                "Exception while getting manufacturer_unique_id --> ",
                                                e,
                                            )
                                            pass
                                        print(
                                        ...
                                        try:
                                            ...
                                            store_name = ""
                                            print(
                                                "Exception while getting store_name --> ",
                                                e,
                                            )
                                            pass
                                        ...
                                        try:
                                            ...
                                            email_id = ""
                                            print(
                                                "Exception while getting email_id --> ",
                                                e,
                                            )
                                            pass
                                        ...
                                        ####################
                                        try:
                                            all_number = dealerloc_soup.find(
                                                "div", {"class": "show-info"}
                                            ).text
                                        except Exception as e:
                                            all_number = ""
                                            print(
                                                "Exception while getting all_number --> ",
                                                e,
                                            )
                                            pass
                                        ...
                                        try:
                                            ...
                                            phone_number = ""
                                            print(
                                                "Exception while getting phone_number --> ",
                                                e,
                                            )
                                            pass
                                        ...
                                        ####################
                                        try:
                                            tel_number = all_number.replace(
                                                phone_number, ""
                                            )
                                        except Exception as e:
                                            tel_number = ""
                                            print(
                                                "Exception while getting tel_number --> ",
                                                e,
                                            )
                                            pass
                                        ...
                                        ################
                                        try:
                                            full_address = dealerloc_soup.find(
                                                "td"
                                            ).next_sibling.next_sibling.text.replace(
                                                all_number, ""
                                            )
                                        except Exception as e:
                                            full_address = ""
                                            print(
                                                "Exception while getting full_address --> ",
                                                e,
                                            )
                                            pass
                                        ...
                                        try:
                                            ...
                                            state = ""
                                            print(
                                                "Exception while getting state --> ", e
                                            )
                                            pass
                                        print("state --> ", state)
                                        items["state"] = state
                                        ...
                                        ####################
                                        try:
                                            district = dealerloc_soup.find(
                                                "td", {"class": "dis-info"}
                                            ).text
                                        except Exception as e:
                                            district = ""
                                            print(
                                                "Exception while getting district --> ",
                                                e,
                                            )
                                            pass
                                        ...
                                        try:
                                            ...
                                            pincode = ""
                                            print(
                                                "Exception while getting pincode --> ",
                                                e,
                                            )
                                            pass
                                        ...
                                        try:
                                            ...
                                            brand = ""
                                            print(
                                                "Exception while getting brand --> ", e
                                            )
                                            pass
                                        print("brand --> ", brand)
                                        items["brand"] = brand
                                        ...
                                        print(
                                            "ALREADY EXISTING SO NOT EXTRACTING --> ",
                                            full_address_check,
                                        )
                ...
                ########################################
                dealerlocfs100 = driver.find_element_by_xpath(
                    '//*[@id="dealerlocfs100"]'
                ).get_attribute("outerHTML")
                ...
                try:
                    ...
                    if tr is not None:
                        if tr != '<tr><td colspan="4">No Dealer Found! </td></tr>':
                            try:
                                ...
                                if "Found" not in store_name_check:
                                    full_address_check = dealerlocfs100_soup.find(
                                        "td"
                                    ).next_sibling.next_sibling.text
                                    if full_address_check not in keys:
                                        keys.append(full_address_check)
                                        ...
                                        ####################
                                        try:
                                            store_name = dealerlocfs100_soup.find(
                                                "td"
                                            ).text
                                        except Exception as e:
                                            store_name = ""
                                        ...
                                        ####################
                                        try:
                                            all_number = dealerlocfs100_soup.find(
                                                "div", {"class": "show-info"}
                                            ).text
                                        except Exception as e:
                                            all_number = ""
                                        ...
                                        ################
                                        try:
                                            full_address = dealerlocfs100_soup.find(
                                                "td"
                                            ).next_sibling.next_sibling.text.replace(
                                                all_number, ""
                                            )
                                        ...
                                        ####################
                                        try:
                                            district = dealerlocfs100_soup.find(
                                                "td", {"class": "dis-info"}
                                            ).text
                                        except Exception as e:
                                            district = ""
                    ...
                    print("No Data Found", e)
                ########################################
                dealerloc_bridge = driver.find_element_by_xpath(
                    '//*[@id="dealerloc_bridge"]'
                ).get_attribute("outerHTML")
                    ...
                    if tr is not None:
                        if tr != '<tr><td colspan="4">No Dealer Found! </td></tr>':
                            try:
                                ...
                                if "Found" not in store_name_check:
                                    full_address_check = dealerloc_bridge_soup.find(
                                        "td"
                                    ).next_sibling.next_sibling.text
                                    if full_address_check not in keys:
                                        keys.append(full_address_check)
                                        ...
                                        ####################
                                        try:
                                            store_name = dealerloc_bridge_soup.find(
                                                "td"
                                            ).text
                                        except Exception as e:
                                            store_name = ""
                                        ...
                                        ####################
                                        try:
                                            all_number = dealerloc_bridge_soup.find(
                                                "div", {"class": "show-info"}
                                            ).text
                                        except Exception as e:
                                            all_number = ""
                                        ...
                                        ################
                                        try:
                                            full_address = dealerloc_bridge_soup.find(
                                                "td"
                                            ).next_sibling.next_sibling.text.replace(
                                                all_number, ""
                                            )
                                        ...
                                        ####################
                                        try:
                                            district = dealerloc_bridge_soup.find(
                                                "td", {"class": "dis-info"}
                                            ).text
                                        except Exception as e:
                                            district = ""
