...
class PirellityresspiderSpider(scrapy.Spider):
    ...
    start_urls = [
        "https://www.pirelli.com/tyres/en-in/car/find-your-dealer/dealer-locator?city=Mumbai%2C+Maharashtra%2C+India"
    ]
    ...
    def parse(self, response, **kwargs):
        ...
        for post in postals:
            ...
            driver.find_element_by_xpath('//*[@id="locatorField"]').send_keys(
                Keys.ARROW_DOWN
            )
            ...
            listt = driver.find_element_by_xpath(
            ...
            for div in templatenode:
                ...
                if dealer_code not in keys:
                    ...
                    try:
                        store_name = (
                            div.find("div", {"class": "dlHeadline"}).find("strong").text
                        )
                    except Exception as e:
                        store_name = ""
