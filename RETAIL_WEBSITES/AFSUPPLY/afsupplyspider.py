    ...
    def parse(self, response, **kwargs):
        ...
        try:
            title = response.xpath(
                '//*[@id="maincontent"]/div[2]/div[1]/div[2]/div[1]/h1/span/text()'
            ).extract_first()
            if title is None:
                exit()
        ...
        try:
            sku = response.xpath(
                '//*[@id="maincontent"]/div[2]/div[1]/div[2]/div[2]/div[1]/div[2]/div[@class="value"]/text()'
            ).extract_first()
            if sku is True:
                sku = response.xpath(
                    '//*[@id="maincontent"]/div[2]/div[1]/div[2]/div[2]/div[1]/div[2]/div[@class="value"]/text()'
                ...
                sku = response.xpath(
                    '//*[@id="maincontent"]/div[2]/div[1]/div[2]/div[2]/div[1]/div/div/text()'
                ).extract_first()
        except Exception as e:
            sku = ""
        ...
        try:
            stock = response.xpath(
                '//*[@id="maincontent"]/div[2]/div[1]/div[2]/div[2]/div[1]/div[@class="availability only"]/strong/text()'
            ).extract_first()
            if stock is True:
                stock = response.xpath(
                    '//*[@id="maincontent"]/div[2]/div[1]/div[2]/div[2]/div[1]/div[@class="availability only"]/strong/text()'
            ...
            if stock is None:
                stock = response.xpath(
                    '//*[@id="maincontent"]/div[2]/div[1]/div[2]/div[2]/p/span/text()'
                ).extract_first()
            if stock is None:
                stock = response.xpath(
                    '//*[@id="maincontent"]/div[2]/div[1]/div[2]/div[2]/div[2][@class="shipinfo-right"]/span[4]/strong/text()'
                ).extract_first()
            if stock is None:
                stock = response.xpath(
                    '//*[@id="maincontent"]/div[2]/div[1]/div[2]/div[2][@class="product-info-price"]/span/strong/text()'
                ).extract_first()
        except Exception as e:
            stock = ""
        ...
        try:
            if (
                response.xpath(
                    '//*[@data-price-type="oldPrice"]/span/text()'
                ).extract_first()
                is None
            ):
                retail_price = ""
            else:
                retail_price = response.xpath(
                    '//*[@data-price-type="oldPrice"]/span/text()'
                ).extract_first()
        except Exception as e:
            retail_price = ""
        ...
        for table_row in table_rows:
            specs[
                table_row.xpath('th[@class="col label"]/text()').extract_first().strip()
            ] = (
            ...
            if (
                ...
                mpn = (
                    table_row.xpath('td[@class="col data"]/text()')
                    .extract_first()
                    .strip()
                )
                if (
        ...
        try:
            ...
            if docs is None:
                ...
                doks = "https://www.afsupply.com" + (
                    response.xpath('//*[@id="demo.tab"]/a/@href').extract_first()
                )
