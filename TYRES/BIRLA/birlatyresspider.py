    ...
    def parse(self, response, **kwargs):
        ...
        for post in postals:
            ...
            for div in search_container:
                ...
                ####################
                try:
                    pincode = div.br.next_sibling.next_sibling.next_sibling.next_sibling.next_sibling.next_sibling.next_sibling.next_sibling.next_sibling.replace(
                        "\t", ""
                    ).replace(
                        "\n", ""
                    )
                    if "Phone" in pincode:
                        pincode = div.br.next_sibling.next_sibling.next_sibling.next_sibling.next_sibling.next_sibling.next_sibling.replace(
                            "\t", ""
                        ).replace(
                            "\n", ""
                        )
                ...
                try:
                    phone_number = (
                        div.br.next_sibling.next_sibling.next_sibling.next_sibling.next_sibling.next_sibling.next_sibling.next_sibling.next_sibling.replace(
                            "\t", ""
                        )
                        .replace("\n", "")
                        .replace("Phone :", "")
                    ...
                    if phone_number == pincode:
                        phone_number = (
                            div.br.next_sibling.next_sibling.next_sibling.next_sibling.next_sibling.next_sibling.next_sibling.next_sibling.next_sibling.next_sibling.next_sibling.replace(
                                "\t", ""
                            )
                            .replace("\n", "")
                            .replace("Phone :", "")
                ...
                ####################
                try:
                    state = div.br.next_sibling.next_sibling.next_sibling.next_sibling.next_sibling.next_sibling.next_sibling.replace(
                        "\t", ""
                    ).replace(
                        "\n", ""
                    )
                    if pincode in state:
                        state = div.br.next_sibling.next_sibling.next_sibling.next_sibling.next_sibling.replace(
                            "\t", ""
                        ).replace(
                            "\n", ""
                        )
