...
class BridgestonetyresspiderSpider(scrapy.Spider):
    ...
    def parse(self, response, **kwargs):
        ...
        for district in districts:
            ...
            if "display: block;" == driver.find_element_by_xpath(
                "/html/body/section[3]"
            ).get_attribute("style"):
                ...
                while True:
                    ...
                    if "disabled" not in driver.find_element_by_xpath(
                        '//*[@id="pagination"]/li[5]'
                    ).get_attribute("class"):

                        next_page_class = driver.find_element_by_xpath(
                            '//*[@id="pagination"]/li[5]'
                        ).get_attribute("class")
                        ...
                        for data in search_container:
                            ...
                            try:
                                ...
                                yield scrapy.Request(
                                    store_link, callback=self.parse_items
                                )
                    ...
                    elif "page-item next disabled" in driver.find_element_by_xpath(
                        '//*[@id="pagination"]/li[5]'
                    ).get_attribute("class"):

                        next_page_class_two = driver.find_element_by_xpath(
                            '//*[@id="pagination"]/li[5]'
                        ).get_attribute("class")
    ...
    def parse_items(self, response):
        ...
        try:
            store_name = response.xpath(
                "/html/body/section[3]/div/div/div[1]/h3/text()"
            ).extract()
        except Exception as e:
            store_name = ""
        ...
        try:
            full_address = response.xpath(
                "/html/body/section[3]/div/div/div[1]/ul/li[1]/text()"
            ).extract_first()
        except Exception as e:
            full_address = ""
        ...
        try:
            phone_number = response.xpath(
                "/html/body/section[3]/div/div/div[1]/ul/li[2]/text()"
            ).extract_first()
        except Exception as e:
            phone_number = ""
        ...
        try:
            google_maps_direction_url = response.xpath(
                "/html/body/section[3]/div/div/div[1]/ul/li[4]/a/@href"
            ).extract_first()
        except Exception as e:
        ...
        try:
            appointment_booking_url = response.xpath(
                "/html/body/section[3]/div/div/div[1]/ul/li[5]/a/@href"
            ).extract_first()
        except Exception as e:
