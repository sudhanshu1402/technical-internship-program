...
class PincodespiderSpider(scrapy.Spider):
    ...
    def parse(self, response, **kwargs):
        ...
        box1 = response.xpath(
            "/html/body/div[3]/div[3]/div[1]/div[2]/div[1]/div[3]/ul//@href"
        ).extract()
        for href in box1:
            print("href --> ", href)
    ...
    def parse_items(self, response):
        table = response.xpath(
            "/html/body/div[3]/div[3]/div[1]/div[2]/div[1]/div[3]/table"
        )

        for lop in table:
            pins = lop.xpath(
                "/html/body/div[3]/div[3]/div[1]/div[2]/div[1]/div[3]/table/tbody//tr/td[5]/text()"
            )
            for pin in pins:
                p = pin.extract()
