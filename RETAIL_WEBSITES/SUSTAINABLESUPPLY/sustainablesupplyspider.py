...
class SustainablesupplyspiderSpider(scrapy.Spider):
    ...
    def parse(self, response, **kwargs):
        ...
        yield scrapy.Request(
            url, callback=self.parse2, errback=self.parse_items, dont_filter=True
        )
    ...
    def parse2(self, response):
        for href in driver.find_elements_by_xpath(
            '//*[@id="searchspring-content"]/section/div/div[2]/div/div/a'
        ):
            view_url = "https://www.sustainablesupply.com" + str(
                href.get_attribute("ng-href")
            )
    ...
    def parse_items(self, response):
        ...
        try:
            title = response.xpath(
                '//*[@id="shopify-section-product-template"]/section/div[1]/div[2]/div/div[2]/div/div[1]/div/h1/text()'
            ).extract_first()
        except Exception as e:
            title = ""
        ...
        try:
            sku = response.xpath(
                '//*[@id="shopify-section-product-template"]/section/div[1]/div[2]/div/div[2]/div/div[1]/div/div/span[1]/span/text()'
            ).extract_first()
        except Exception as e:
            sku = ""
        ...
        try:
            brand = response.xpath(
                '//*[@id="shopify-section-product-template"]/section/div[1]/div[2]/div/div[2]/div/div[1]/div/div/a/text()'
            ).extract_first()
        except Exception as e:
            brand = ""
        ...
        try:
            mpn = response.xpath(
                '//*[@id="shopify-section-product-template"]/section/div[1]/div[2]/div/div[2]/div/div[1]/div/div/span[2]/text()'
            ).extract_first()
        except Exception as e:
            mpn = ""
        ...
        try:
            weight = response.xpath(
                '//*[@id="shopify-section-product-template"]/section/div[1]/div[2]/div/div[2]/div/div[1]/div/div/span[3]/text()'
            ).extract_first()
        except Exception as e:
            weight = ""
        ...
        try:
            price = (
                response.xpath('//*[@class="price price--highlight"]/text()')
                .extract_first()
                .replace("$", "")
            )
        except Exception as e:
        ...
        try:
            desc = response.xpath(
                '//*[@class="product-block-list__item product-block-list__item--description"]/div/div/div/p/text()'
            ).extract_first()
            if desc is None:
                desc = response.xpath(
                    '//*[@class="product-block-list__item product-block-list__item--description"]/div/div/div/p/strong/text()'
                ).extract_first()
        except Exception as e:
            desc = ""
        ...
        try:
            images = {}
            product_imgurls = response.xpath(
                '//meta[@property="og:image:secure_url"]/@content'
            ).extract()
            for img_urls in range(len(product_imgurls)):
                images.update(
                    {"image_url_" + str(img_urls + 1): product_imgurls[img_urls]}
                )
        except Exception as e:
            images = ""
        ...
        try:
            ...
            document_urls = response.xpath(
                '//*[@id="shopify-section-product-template"]/section/div[1]/div[2]/div/div[4]//tr/td/a/@href'
            ).extract()
